    ...
    --></div>
        ...
        <th>
            ...
            <tbody>
                ...
                <td><button class="btn btn-info" onclick="window.location.href = 'editAccount/{{ $user->id }}';" data-toggle="modal" value="Edit">Edit</button>
                    <button class="btn btn-danger" onclick="window.location.href = 'deleteAccount/{{ $user->id }}';">Delete</button>
                </td>
                </tr>
                @endforeach
                            <!-- Modal Delete-->
