        ...
        <form class="form" method="POST" action="createaccount">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="keterangan" name="password" class="form-control" required>
                </div>
...
{{--
            ...
            <div class="modal-footer">
                <input type="button" onclick="window.location.href = '/home;" class="btn btn-default" data-dismiss="modal" value="Cancel">
                <input type="submit" class="btn btn-success" value="Register Account">
            </div>
        </form>
</div>
</div>
